...
public class pole extends JPanel{
	...
	public pole() {
		...
		myGame.start();
		try {
			fon = ImageIO.read(new File("Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Попова\\ИП22\\Zubkovskiy Jotaro\\белые кораблики , мясо, взрывы\\Картинки морской бой\\fon.png"));
			paluba = ImageIO.read(new File("Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Попова\\ИП22\\Zubkovskiy Jotaro\\белые кораблики , мясо, взрывы\\Картинки морской бой\\paluba.png"));
			ranen = ImageIO.read(new File("Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Попова\\ИП22\\Zubkovskiy Jotaro\\белые кораблики , мясо, взрывы\\Картинки морской бой\\ranen.png"));	
			ubit = ImageIO.read(new File("Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Попова\\ИП22\\Zubkovskiy Jotaro\\белые кораблики , мясо, взрывы\\Картинки морской бой\\ubit.png"));
			...
			bomba = ImageIO.read(new File("Z:\\ГРУППЫ\\ПРОГРАММИСТЫ\\Попова\\ИП22\\Zubkovskiy Jotaro\\белые кораблики , мясо, взрывы\\Картинки морской бой\\bomba.png"));
		}
		catch (Exception ex) {}
	...
	public void paintComponent(Graphics gr) {
		...
		gr.drawString("ДЫО", 150, 50);
		gr.drawString("СТАРДАСТЫ", 590, 50);
		for (int i = 0; i < 10; i++) {
			for (int j = 0; j < 10; j++) {
